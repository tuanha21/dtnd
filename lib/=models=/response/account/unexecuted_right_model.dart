...
class UnexecutedRightModel implements CoreResponseModel {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['C_RIGHT_TYPE'] = cRIGHTTYPE;
    return data;
  }

  @override
  String toString() {
    return 'UnexecutedRightModel{pKRIGHTSTOCKINFO: $pKRIGHTSTOCKINFO, cRIGHTTYPENAME: $cRIGHTTYPENAME, cRIGHTTYPENAMEEN: $cRIGHTTYPENAMEEN, cRIGHTBUYFLAG: $cRIGHTBUYFLAG, cRIGHTRATE: $cRIGHTRATE, cCASHRECEIVERATE: $cCASHRECEIVERATE, cSHARECODE: $cSHARECODE, cSHARENAME: $cSHARENAME, cRECEIVESHARECODE: $cRECEIVESHARECODE, cXDATE: $cXDATE, cCLOSEDATE: $cCLOSEDATE, cEXECUTEDATE: $cEXECUTEDATE, cDUEDATE: $cDUEDATE, cTRANSFERFROMDATE: $cTRANSFERFROMDATE, cTRANSFERTODATE: $cTRANSFERTODATE, cREGISTERFROMDATE: $cREGISTERFROMDATE, cREGISTERTODATE: $cREGISTERTODATE, cTRANSFERTYPE: $cTRANSFERTYPE, cFLAG: $cFLAG, cTRANSFERNAME: $cTRANSFERNAME, cSTATUSNAME: $cSTATUSNAME, cSTATUSNAMEEN: $cSTATUSNAMEEN, cACCOUNTCODE: $cACCOUNTCODE, cBUYPRICE: $cBUYPRICE, cSHAREBUY: $cSHAREBUY, cCASHBUY: $cCASHBUY, cSHAREDIVIDENT: $cSHAREDIVIDENT, cSHAREODDLOT: $cSHAREODDLOT, cCASHODDLOT: $cCASHODDLOT, cCASHVOLUME: $cCASHVOLUME, cTAXVOLUME: $cTAXVOLUME, cNOTE: $cNOTE, cSHAREVOLUME: $cSHAREVOLUME, cRIGHTRECEIVER: $cRIGHTRECEIVER, cRIGHTTRANSFER: $cRIGHTTRANSFER, cRIGHTVOLUME: $cRIGHTVOLUME, cSHARERIGHT: $cSHARERIGHT, cCASHBUYALL: $cCASHBUYALL, cBUSINESSNAME: $cBUSINESSNAME, cBUSINESSNAMEEN: $cBUSINESSNAMEEN, cBUSINESSCODE: $cBUSINESSCODE, cCREATEDATE: $cCREATEDATE, cRIGHTTYPE: $cRIGHTTYPE}';
  }
}
