...
class HomeSimpleLineChart extends StatefulWidget {
  const HomeSimpleLineChart({
    super.key,
    this.data,
    this.getData,
    this.kColor,
  ...
  @override
  State<HomeSimpleLineChart> createState() => _HomeSimpleLineChartState();
}

class _HomeSimpleLineChartState extends State<HomeSimpleLineChart> {
  ...
  @override
  void didUpdateWidget(covariant HomeSimpleLineChart oldWidget) {
